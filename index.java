    ...
    public void actionPerformed(ActionEvent e){
	   ...
	   int nob = Integer.parseInt(jt10.getText());
	    ...
	    try{
		   ...
		   if(st.executeUpdate("insert into student values("+sn+",'"+student_id+"','"+fname+"','"+lname+"','"+email+"','"+mobile+"','"+gender+"','"+branch+"',"+tenth+","+twe+","+btech+","+nob+")")>0){
